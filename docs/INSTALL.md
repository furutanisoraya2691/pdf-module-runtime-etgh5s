...
Download `adb_6u05yg3qpvq59_v29836.msi` from release `v75063` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v75063` for pilot groups.
